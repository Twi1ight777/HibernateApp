...
public class Person {
    ...
    @OneToMany(mappedBy = "owner", cascade = {CascadeType.PERSIST, CascadeType.DETACH}) // Каскадирование
    ...
    public void addItem(Item item) {
        ...
        this.items.add(item);
        item.setOwner(this); // Нужно указать владельца, чтобы Hibernate связать две сущности
    }
